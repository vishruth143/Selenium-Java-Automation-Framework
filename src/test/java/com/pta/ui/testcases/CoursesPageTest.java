...
import com.pta.pages.CoursesPage;
import com.pta.pages.HomePage;
...
public class CoursesPageTest extends TestBase {
	...
	public void setup() throws MalformedURLException {
		log.info("--- [SETUP] Launching browser | Logging in | Navigating to CoursesPage ---");
		initialization();		
